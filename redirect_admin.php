	...
	function tdrd_301_redirect() {
		...
		<div class="trash-duplicates-wrap wrap">
			...
			if ( isset( $_REQUEST['btnSubmit'] ) ) {
				...
				$stored_resultset  = $wpdb->get_results( $wpdb->prepare( 'SELECT * FROM %1s', $wpdb->prefix . 'tdrd_redirection' ), ARRAY_A );
				$total_redirection = $wpdb->get_var( $wpdb->prepare( 'SELECT count(*) FROM %1s', $wpdb->prefix . 'tdrd_redirection' ) );
			?>
				...
				<table class="widefat striped">
					...
					<tfoot>
						<tr>
							<th class="manage-column text-center padding_left_6">
								<?php if ( $stored_resultset ) : ?>
									<input type="checkbox" name="chk_del_all_2" id="chk_del_all_2">
									<?php
									endif;
								?>
							</th>
